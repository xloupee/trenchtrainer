...
function useGameEngine(startDiff=1,seed=null,maxDiffCap=10,maxMultiplierCap=3,options={}){
  const FEED_MAX=40;
  const roundTimeLimitMs=Number.isFinite(options?.roundTimeLimitMs)&&options.roundTimeLimitMs>0?Math.round(options.roundTimeLimitMs):null;
